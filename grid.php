  ...
  <div class="container-fluid mt-3">
    <div class="row">
      <div class="col-lg-2 grid1">
        <div class="grid1-child grid1-item-1 text-center pt-5" data-bs-toggle="modal"
      ...
      <div class="col-lg-4 grid2">
        <div class="grid2-child grid2-item-1  py-3 " data-bs-toggle="modal"
          data-bs-target="#new-modal"> <div class="text-center">
          ...
          <!-- <i class="fa-solid fa-ballot-check grid-icon"></i> -->
        </div>
        <p class="text-light text-uppercase text-left px-2 pb-2">casting master</p>
      </div>
        <div class="grid2-child grid2-item-2  py-2"><div class="text-center">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button
            ...
            aria-label="Close"><i class="fa-solid fa-xmark pb-3"></i></button>
          ...
          <form action="" method="post">
            <section id="profile-form">
              <div class="row justify-content-center">
                ...
                <div class="col-1">
                  <i class="fa-sharp fa-regular fa-pen-to-square" style="color: #4b6d75;"></i>
                  <p class="text-para">Edit</p>
                </div>
                <div class="col-1">
